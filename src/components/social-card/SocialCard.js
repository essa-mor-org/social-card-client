...
function SocialCard() {
	return (<div className="Social_card">
		...
		<SocialCardComments
			...
			comments={[
				{ profileImage: 'https://scontent.ftlv4-1.fna.fbcdn.net/v/t1.0-1/c0.0.48.48/p48x48/30571266_10211755395060285_621329575565066240_n.jpg?_nc_cat=0&oh=755d9aa650987a5b1519cdbaeeedcd8c&oe=5BEA6497', profileName: 'Tyler Schmidt', comment: 'Written by Lady Gaga' },
				{ profileImage: 'https://scontent.ftlv4-1.fna.fbcdn.net/v/t1.0-1/c0.0.48.48/p48x48/30571266_10211755395060285_621329575565066240_n.jpg?_nc_cat=0&oh=755d9aa650987a5b1519cdbaeeedcd8c&oe=5BEA6497', profileName: 'Tyler Schmidt', comment: 'Man they confiscated my pages Have a great day' }
			]} />
	</div>);
}
